        					 ...
        					 (topBlock != Blocks.air && par3World.getBlock(xxx, yyy - 1, zzz) == topBlock)))
        {
            ...
            if (ran3 == 0)
            {
                ...
                if (tileentitymobspawner1 != null)
                {
            		...
            		if(rand.nextInt(2) == 0)
            		{
            			tileentitymobspawner1.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomNightName());
            		}else
            		{
            			tileentitymobspawner1.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomDayName());
            		}
                }
                else
                {
            ...
            if (ran4 == 0)
            {
                ...
                if (tileentitymobspawner2 != null)
                {
            		...
            		if(rand.nextInt(2) == 0)
            		{
            			tileentitymobspawner2.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomNightName());
            		}else
            		{
            			tileentitymobspawner2.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomDayName());
            		}
                }
                else
                {
            ...
            if (ran5 == 0)
            {
                ...
                if (tileentitymobspawner3 != null)
                {
            		...
            		if(rand.nextInt(2) == 0)
            		{
            			tileentitymobspawner3.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomNightName());
            		}else
            		{
            			tileentitymobspawner3.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomDayName());
            		}
                }
                else
                {
            ...
            if (ran6 == 0)
            {
                ...
                if (tileentitymobspawner4 != null)
                {
            		if(rand.nextInt(2) == 0)
            		{
            			tileentitymobspawner4.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomNightName());
            		}else
            		{
            			tileentitymobspawner4.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomDayName());
            		}
                }
                else
                {
            ...
            if (chest != null)
            {
            	if(rand.nextInt(3) != 0)
            	{
            		DQM.randomItem.generateChestContentsRank1(rand, chest);
            	}else
            	{
            		DQM.randomItem.generateChestContentsRank2(rand, chest);
            	}
            }
            ...
            if (chest2 != null)
            {
            	if(rand.nextInt(3) != 0)
            	{
            		DQM.randomItem.generateChestContentsRank1(rand, chest2);
            	}else
            	{
            		DQM.randomItem.generateChestContentsRank2(rand, chest2);
            	}
            }
            ...
            if (chest3 != null)
            {
            	if(rand.nextInt(3) != 0)
            	{
            		DQM.randomItem.generateChestContentsRank1(rand, chest3);
            	}else
            	{
            		DQM.randomItem.generateChestContentsRank2(rand, chest3);
            	}
            }
            ...
            if (chest4 != null)
            {
            	if(rand.nextInt(3) != 0)
            	{
            		DQM.randomItem.generateChestContentsRank1(rand, chest4);
            	}else
            	{
            		DQM.randomItem.generateChestContentsRank2(rand, chest4);
            	}
            }
        }
    }
