package dqmIII.world.genVillage;
...
public class ComponentVillageKaitoriyaHouse extends StructureVillagePieces.Village {
	...
	public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_)
    {
        ...
        this.placeBlockAtCurrentPosition(p_74875_1_, DQM.decorateBlocks.DqmBlockDouguya, this.coordBaseMode, 2, 2, 0, p_74875_3_);
        this.placeBlockAtCurrentPosition(p_74875_1_, DQM.decorateBlocks.DqmBlockDouguya, this.coordBaseMode, 6, 2, 0, p_74875_3_);
	...
	protected int getVillagerType(int par1) {
		 ...
		 */
		return DQM.villager.vlgBukiyaID;
		//return 0;
	}
