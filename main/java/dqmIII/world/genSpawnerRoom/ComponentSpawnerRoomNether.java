...
public class ComponentSpawnerRoomNether extends StructureComponent {
	...
	public boolean addComponentParts(World world, Random random, StructureBoundingBox structureboundingbox) {
		...
		*/
        ...
        {
        	tileentitymobspawner.func_145881_a().setEntityName(DQM.modID + "." + DQM.randomMob.getRandomNetherName());
        }
        else
        {
        	...
        	for(int cnt = 0; cnt < chestCnt; cnt++)
        	{
	        	...
	        	if(this.zWidth > 1 && this.zWidth > 1)
	        	{
		        	...
		        	if(world.getTileEntity(offX, offY, offZ) == null)
		        	{
			            ...
			            {
			            	DQM.randomItem.generateChestContentsRank3(random, tileentitychest);
			            	this.setChest = true;
			            }
		        	}
	        	}
