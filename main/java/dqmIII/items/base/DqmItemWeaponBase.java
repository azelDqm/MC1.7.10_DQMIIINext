...
public class DqmItemWeaponBase extends Item{
    ...
    public void onUpdate(ItemStack var1, World var2, Entity var3, int par4, boolean par5)
    {
    	if(!var2.isRemote)
    	{
    		if(var3 instanceof EntityPlayer)
    		{
    			...
    			int idx = 0;
    			if(this.field_150933_b == DQM.dqmMaterial.DqmAxe)
    			{
    				idx = 1;
    			}else if(this.field_150933_b == DQM.dqmMaterial.DqmHammer0 || this.field_150933_b == DQM.dqmMaterial.DqmHammer1 || this.field_150933_b == DQM.dqmMaterial.DqmHammer2 || this.field_150933_b == DQM.dqmMaterial.DqmHammer3)
    			{
    				idx = 2;
    			}else if(this.field_150933_b == DQM.dqmMaterial.DqmClaw)
    			{
    				idx = 3;
    			}

    			this.mode = ExtendedPlayerProperties.get(ep).getWeaponMode(idx);
	    	...
	    	if(perDam < 800 && this.getMaterial() != DQM.dqmMaterial.DqmFist)
	    	{
    ...
    public float func_150893_a(ItemStack p_150893_1_, Block p_150893_2_)
    {
        ...
        {
        	if(this.field_150933_b == DQM.dqmMaterial.DqmAxe && mode == 0)
        	{
        		//DQ斧の場合の処理
        	...
        	}else if(mode == 0 && (this.field_150933_b == DQM.dqmMaterial.DqmHammer0 || this.field_150933_b == DQM.dqmMaterial.DqmHammer1 || this.field_150933_b == DQM.dqmMaterial.DqmHammer2 || this.field_150933_b == DQM.dqmMaterial.DqmHammer3))
        	{
        		//DQツルハシの場合の処理
        		if(p_150893_2_ == Blocks.obsidian && this.field_150933_b == DQM.dqmMaterial.DqmHammer3)
        		{
        			 return this.efficiencyOnProperMaterial;
        	...
        	}else if(this.field_150933_b == DQM.dqmMaterial.DqmClaw && mode == 0)
        	{
        		//DQ爪の場合の処理
