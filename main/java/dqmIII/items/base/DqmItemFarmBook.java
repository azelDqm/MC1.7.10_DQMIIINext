...
public class DqmItemFarmBook extends Item {
    ...
    public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer player) {
    	...
    	if(player.worldObj.isRemote)
    	{
    		player.openGui(DQM.instance, DQM.conf.GuiID_FarmBook, world, MathHelper.ceiling_double_int(player.posX), MathHelper.ceiling_double_int(player.posY), MathHelper.ceiling_double_int(player.posZ));
    	}
        return itemStack;
    }
