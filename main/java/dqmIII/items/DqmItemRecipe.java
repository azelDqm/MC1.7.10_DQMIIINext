...
public class DqmItemRecipe {
	...
	public DqmItemRecipe()
	{
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemKuresentoejji, 1), new Object[] {new ItemStack(DQWeapons.itemKazenobumeran, 1), new ItemStack(DQMiscs.itemYumiNage, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemHaipanova, 1), new Object[] {new ItemStack(DQWeapons.itemKuresentoejji, 1), new ItemStack(DQMiscs.itemYumiNage, 1), new ItemStack(DQMiscs.itemDensetu, 1)});
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemSaramanda, 1), new Object[] {new ItemStack(DQWeapons.itemSodobureika, 1), new ItemStack(DQMiscs.itemKenTanken, 1), new ItemStack(DQMiscs.itemHonooRyuu, 1)});
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemDoragonkuro, 1), new Object[] {new ItemStack(DQWeapons.itemAkumanotume, 1), new ItemStack(DQMiscs.itemYariMutiTume, 1), new ItemStack(DQMiscs.itemHonooRyuu, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemMegaminomuti, 1), new Object[] {new ItemStack(DQWeapons.itemDoragonteiru, 1), new ItemStack(DQMiscs.itemYariMutiTume, 1), new ItemStack(DQMiscs.itemMahou, 1)});
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemTyouguringamunomuti, 1), new Object[] {new ItemStack(DQWeapons.itemGuringamunomuti, 1), new ItemStack(DQMiscs.itemYariMutiTume, 1), new ItemStack(DQMiscs.itemHakai, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemSinryuunotume, 1), new Object[] {new ItemStack(DQWeapons.itemDoragonkuro, 1), new ItemStack(DQMiscs.itemYariMutiTume, 1), new ItemStack(DQMiscs.itemHonooRyuu, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemHosikudaki, 1), new Object[] {new ItemStack(DQWeapons.itemOninokanabou, 1), new ItemStack(DQMiscs.itemOnoTutiKon, 1), new ItemStack(DQMiscs.itemHakai, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemDaitinokanaduti, 1), new Object[] {new ItemStack(DQWeapons.itemDaitikudaki, 1), new ItemStack(DQMiscs.itemOnoTutiKon, 1), new ItemStack(DQMiscs.itemHakai, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemHakainotekkyuu, 1), new Object[] {new ItemStack(DQWeapons.itemTyouguringamunomuti, 1), new ItemStack(DQMiscs.itemOnoTutiKon, 1), new ItemStack(DQMiscs.itemHakai, 1), new ItemStack(DQMiscs.itemDensetu, 1)});
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemDoragonroddo, 1), new Object[] {new ItemStack(DQIngots.itemOriharukon, 1), new ItemStack(DQMiscs.itemOnoTutiKon, 1), new ItemStack(DQMiscs.itemHonooRyuu, 1)});
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(DQWeapons.itemNyoraikon, 1), new Object[] {new ItemStack(DQWeapons.itemDoragonroddo, 1), new ItemStack(DQMiscs.itemOnoTutiKon, 1), new ItemStack(DQMiscs.itemMahou, 1)});
...
*/
        ...
        */
        ...
        //GameRegistry.addShapelessRecipe(new ItemStack(DQArmors.itemNiku4, 1), new Object[] {new ItemStack(DQMiscs.itemNiku3, 1), new ItemStack(DQIngots.itemTaiyounoisi, 1), new ItemStack(DQIngots.itemTaiyounoisi, 1)});
