...
import dqmIII.blocks.decorate.model.DqmModelMinidama;
import dqmIII.blocks.decorate.tileEntity.DqmTileEntityMinidama;
...
public class DqmTileEntityRenderMinidama extends TileEntitySpecialRenderer
{
    ...
    public void doRenderModel(DqmTileEntityMinidama var1, double var2, double var4, double var6, float var8)
    {
        ...
        this.bindTexture(new ResourceLocation("dqm:textures/model/miniDama3.png"));
        GL11.glPushMatrix();
