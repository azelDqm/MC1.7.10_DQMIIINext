...
import dqmIII.blocks.decorate.model.DqmModelRotomon;
import dqmIII.blocks.decorate.tileEntity.DqmTileEntityRotomon;
...
public class DqmTileEntityRenderRotomon extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        ...
        //テクスチャー
        this.bindTexture(new ResourceLocation("dqm:textures/model/Rotomon.png"));
        GL11.glPushMatrix();
