...
import dqmIII.blocks.decorate.model.DqmModelKagaribidai;
import dqmIII.blocks.decorate.tileEntity.DqmTileEntityKagaribidai;
...
public class DqmTileEntityRenderKagaribidai extends TileEntitySpecialRenderer
{
    ...
    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8)
    {
        ...
        this.bindTexture(new ResourceLocation("dqm:textures/model/KagaribidaiSSS.png"));
        GL11.glPushMatrix();
