...
import dqmIII.DQM;
import dqmIII.blocks.decorate.tileEntity.DqmTileEntityAkumanotubo;
...
public class DqmBlockAkumanotubo2 extends BlockContainer
{
    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        }else
        {
            ...
            {
            	doropiItems = new ItemStack(DQM.decorateBlocks.DqmBlockAkumanotubo, 1);
            }
        }
...
*/
    ...
    */
    ...
    {
        this.blockIcon = var1.registerIcon("dqm:Akumanotubo");
    }
