...
import dqmIII.DQM;
import dqmIII.blocks.decorate.tileEntity.DqmTileEntitySwordMob;
...
public class DqmBlockBlockSwordMob extends BlockContainer
{
    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if(dim == 0)
        {
        	if(rand.nextInt(4) != 0)
        	{
        		...
        		doropiItems = DQM.randomItem.getWeaponRank1(1, 1);
        	}else
        	{
        		if(rand.nextInt(4) == 0)
        		{
        		...
        		doropiItems = DQM.randomItem.getWeaponRank2(1, 1);
        	}
        }else if(dim == -1)
        {
        	...
        	if(rateMob == 0)
        	{
        		...
        		doropiItems = DQM.randomItem.getWeaponRank4(1, 1);

        	}else if(rateMob < 4)
        	{
        		spawnMob = DQM.randomMob.getRandomNether(par1World);
        		doropiItems = DQM.randomItem.getWeaponRank3(1, 1);
        	}else
        	{
        		if(rand.nextInt(4) == 0)
        		{
        ...
        }else
        {
        	...
        	if(rateMob == 0)
        	{
        		...
        		doropiItems = DQM.randomItem.getWeaponRank5(1, 1);
        ...
        {
        	doropiItems = new ItemStack(DQM.decorateBlocks.DqmBlockSword, 1);
        }
    ...
    */
    ...
    {
        this.blockIcon = var1.registerIcon("dqm:SwordsB");
    }
