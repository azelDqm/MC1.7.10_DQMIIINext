package dqmIII.blocks.standard;
...
*/
    ...
    {
    	this.baseIcon = par1IconRegister.registerIcon("dqm:HoujyouDirt");
        this.field_94441_a = par1IconRegister.registerIcon("dqm:HoujyouDirt_wet");
        this.field_94440_b = par1IconRegister.registerIcon("dqm:HoujyouDirt_dry");
    }
    ...
    public void canNewGerminate(World par1World, int par2, int par3, int par4, Random par5Random)
    {
    	...
    	ArrayList<Integer> keySet1 = DQM.mutationTable.getMutationSeedBlocksKey(keySeed1);
    	ArrayList<Integer> keySet2 = null;

    	if(keySeed2 != null)
    	{
    		keySet2 = DQM.mutationTable.getMutationSeedBlocksKey(keySeed2);
    	}
    	...
    	{
    		Block[] checkBlocks = (Block[])DQM.mutationTable.mutationBlocks.get(keySet1.get(cnt));
    		int[] checkMetas = (int[])DQM.mutationTable.mutationBlockMetas.get(keySet1.get(cnt));
    		Block mutationBlock = (Block)DQM.mutationTable.mutationResultBlocks.get(keySet1.get(cnt));

    		//DQM.func.debugString(DQM.func.equalBlockArray(checkBlocks, keyBlock) + "/" + DQM.func.equalIntArray(checkMetas, BlockMeta));
    		if(DQM.func.equalBlockArray(checkBlocks, keyBlock) && DQM.func.equalIntArray(checkMetas, BlockMeta))
    		{
    			if(rand.nextInt(5) == 0)
    			{
    	...
    	if(keySet2 != null)
    	{
	    	...
	    	{
	    		Block[] checkBlocks = (Block[])DQM.mutationTable.mutationBlocks.get(keySet2.get(cnt));
	    		int[] checkMetas = (int[])DQM.mutationTable.mutationBlockMetas.get(keySet2.get(cnt));
	    		Block mutationBlock = (Block)DQM.mutationTable.mutationResultBlocks.get(keySet2.get(cnt));
