    ...
    public void onBlockDestroyedByPlayer(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if(dim == 0)
        {
        	...
        	if(rand.nextInt(10) != 0)
        	{
        		...
        		if(rateItem == 0)
        		{
        			doropiItems =DQM.randomItem.getBuilderRank1(1, 1);
        		}if(rateItem == 1)
        		{
        			doropiItems =DQM.randomItem.getBuilderRank2(1, 1);
        		}else if(rateItem < 5)
        		{
        			doropiItems =DQM.randomItem.getFoodRank1(1, 1);
        		}else if(rateItem < 8)
        		{
        	...
        	}else
        	{
        		...
        		{
        			doropiItems =DQM.randomItem.getBuilderRank3(1, 1);
        		}else if(rateItem < 5)
        		{
        			doropiItems =DQM.randomItem.getFoodRank1(1, 1);
        		}else if(rateItem < 7)
        		{
        			doropiItems =DQM.randomItem.getFoodRank2(1, 1);
        		}else if(rateItem < 1)
        		{
        			doropiItems =DQM.randomItem.getMiscsRank3(1, 1);
        		}else if(rateItem < 13)
        ...
        {
        	doropiItems = new ItemStack(DQM.blocks.DqmBlockHako3, 1);
        }
