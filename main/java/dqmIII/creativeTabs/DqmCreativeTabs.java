...
public class DqmCreativeTabs {
	...
	//public static final CreativeTabs DqmTabShield = new DqmTabShield("dqmTabShield");
	...
	//public static final CreativeTabs DqmTabFood = new DqmTabFood("dqmTabFood");
