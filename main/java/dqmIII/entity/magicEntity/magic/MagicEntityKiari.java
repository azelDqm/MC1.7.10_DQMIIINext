            		...
            		if (target != null && target.entityHit != null)
            		{
                		...
                		if(pe != null && this.shootingEntity != null && this.shootingEntity instanceof EntityLiving)
                		{
                            ...
                            if (elv instanceof EntityLivingBase)
                            {
                        		...
                        		eb.removePotionEffect(DQM.potion.potionPoison.id);
                            	...
                            	if(this.level > 1)
                            	{
                            		eb.removePotionEffect(DQM.potion.potionPoisonX.id);
                            		eb.removePotionEffect(DQM.potion.debuffHenatosu.id);
                            		eb.removePotionEffect(DQM.potion.debuffMedapani.id);
                            	}
                            ...
                            //ここでヒット時の効果音がなる
                            this.playSound("dqm:player.kenja", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
