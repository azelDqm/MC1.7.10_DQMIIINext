...
public class DqmEntityTyokonuba extends DqmMobBaseTensei
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.TYOKONUBA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.TYOKONUBA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.TYOKONUBA.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQM.funcMob.getCalcDROP(200, 6))
        {
            this.dropItem(DQM.miscs.itemLittlemedal5, 1);
        }
        if (DQM.funcMob.getCalcDROP(1, 1))
        {
            this.dropItem(DQM.weapons.itemDoragonteiru, 1);
        }
