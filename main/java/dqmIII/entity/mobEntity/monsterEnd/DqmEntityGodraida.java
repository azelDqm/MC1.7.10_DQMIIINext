...
public class DqmEntityGodraida extends DqmMobBaseEnd
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.GODRAIDA.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.GODRAIDA.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.GODRAIDA.getPW()));
	}
    ...
    {
        if (DQM.funcMob.getCalcDROP(500, 1))
        {
            this.dropItem(DQM.miscs.itemTouzokunokagi, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.weapons.itemHaganenoturugi, 1);
        }
        if (DQM.funcMob.getCalcDROP(70, 1))
        {
            this.dropItem(DQM.weapons.itemMorohanoturugi, 1);
        }
        if (DQM.funcMob.getCalcDROP(500, 1))
        {
            this.dropItem(DQM.weapons.itemHayabusanoturugi, 1);
        }
        if (DQM.funcMob.getCalcDROP(25, 1))
        {
            this.dropItem(DQM.weapons.itemHaganenoturugi, 1);
        }
        ...
        if (DQM.funcMob.getCalcDROP(50, 1))
        {
            this.dropItem(DQM.miscs.itemKinka, 1);
        }
