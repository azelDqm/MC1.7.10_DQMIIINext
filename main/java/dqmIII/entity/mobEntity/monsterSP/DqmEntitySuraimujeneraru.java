...
public class DqmEntitySuraimujeneraru extends DqmMobBaseSP
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.SURAIMUJENERARU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.SURAIMUJENERARU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.SURAIMUJENERARU.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQM.weapons.itemHayabusanoturugi, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.accs.itemMangetunoring, 1);
        }
        if (DQM.funcMob.getCalcDROP(8, 1))
        {
            this.dropItem(DQM.accs.itemSuraimupiasu, 1);
        }
        if (DQM.funcMob.getCalcDROP(8, 1))
        {
            this.dropItem(DQM.miscs.itemToukonekisu, 1);
        }
        if (DQM.funcMob.getCalcDROP(5, 1))
        {
            this.dropItem(DQM.miscs.itemRedoubu, 1);
        }
        ...
        if (DQM.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQM.miscs.itemSuraimujeneraru, 1);
        }
        if (DQM.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQM.miscs.itemLittlemedal, 1);
