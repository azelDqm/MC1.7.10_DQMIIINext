...
public class DqmEntityWanpakusatan extends DqmMobBaseSP
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.WANPAKUSATAN.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.WANPAKUSATAN.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.WANPAKUSATAN.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQM.funcMob.getCalcDROP(20, 1))
        {
            this.dropItem(DQM.weapons.itemOdinbou, 1);
        }
