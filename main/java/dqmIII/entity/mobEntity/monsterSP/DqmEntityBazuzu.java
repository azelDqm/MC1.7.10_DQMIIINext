...
public class DqmEntityBazuzu extends DqmMobBaseSP
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.BAZUZU.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.BAZUZU.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.BAZUZU.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQM.accs.itemSingonnojuzu, 1);
        }
        ...
        {
            this.dropItem(DQM.miscs.itemPaapuruoubu, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
        ...
        {
            this.dropItem(DQM.miscs.itemBazuzu, 1);
        }
        if (DQM.funcMob.getCalcDROP(5, 1))
        {
