...
public class DqmEntityDesupisaro2 extends DqmMobBaseBoss
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.DESUPISARO2.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.DESUPISARO2.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.DESUPISARO2.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQM.miscs.itemBougu, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.miscs.itemDensetu, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.miscs.itemHakai, 1);
        }
        if (DQM.funcMob.getCalcDROP(20, 1))
        {
            this.dropItem(DQM.miscs.itemHonooRyuu, 1);
        }
        if (DQM.funcMob.getCalcDROP(20, 1))
        {
            this.dropItem(DQM.miscs.itemKenTanken, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.miscs.itemKooriMetaru, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.miscs.itemMahou, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.miscs.itemMaJu, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
        ...
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.miscs.itemTenkuu, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
            this.dropItem(DQM.miscs.itemYariMutiTume, 1);
        }
        if (DQM.funcMob.getCalcDROP(20, 1))
        {
            this.dropItem(DQM.miscs.itemYumiNage, 1);
        }
        if (DQM.funcMob.getCalcDROP(15, 1))
        {
