...
public class DqmEntityEsterk extends DqmMobBaseBoss
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.ESTERK.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.ESTERK.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.ESTERK.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        {
            this.dropItem(DQM.accs.itemAkumanopiasu, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.accs.itemTensinopiasu, 1);
        }
        ...
        if (DQM.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQM.miscs.itemEsterk, 1);
        }
        if (DQM.funcMob.getCalcDROP(3, 1))
        {
            this.dropItem(DQM.miscs.itemLittlemedal, 1);
