...
public class DqmEntityOdoruhouseki extends DqmMobBaseNight
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.ODORUHOUSEKI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.ODORUHOUSEKI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.ODORUHOUSEKI.getPW()));
	}
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.ingots.itemRubinogenseki, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.miscs.itemDoragonnonamida, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.miscs.itemMetaru, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.ingots.itemInotinoisi, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
            this.dropItem(DQM.miscs.itemKinkai, 1);
        }
        if (DQM.funcMob.getCalcDROP(10, 1))
        {
        ...
        if (DQM.funcMob.getCalcDROP(600, 1))
        {
