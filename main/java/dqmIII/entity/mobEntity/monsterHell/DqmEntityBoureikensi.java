...
public class DqmEntityBoureikensi extends DqmMobBaseHell
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(DQM.funcMob.getCalcSPEED(EnumDqmMonster.BOUREIKENSI.getSPEED()));
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(DQM.funcMob.getCalcHP(EnumDqmMonster.BOUREIKENSI.getHP()));
        this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(DQM.funcMob.getCalcPW(EnumDqmMonster.BOUREIKENSI.getPW()));
	}
    ...
    {
        if (DQM.funcMob.getCalcDROP(16, 1))
        {
        ...
        {
            this.dropItem(DQM.ingots.itemPuratina, 1);
        }
        if (DQM.funcMob.getCalcDROP(300, 1))
        {
            this.dropItem(DQM.weapons.itemKoorinoyaiba, 1);
        }
