  ...
  public void onRenderPlayerStatus(RenderGameOverlayEvent event)
  {
	...
	*/
      ...
      if (DQM.conf.CLGuiLogVis == 1)
      {
          ...
          //switch (DQM.conf.CLGuiPos2)
          switch (DQM.conf.CLGuiLogPos)
          {
	          case 1:
	              x = padW;
	              y0 = 2;
          ...
          x = x + DQM.conf.CLGuiLogPosX;
          y0 =y0 + DQM.conf.CLGuiLogPosY;
          ...
          ResourceLocation reLoc;// = new ResourceLocation("dqm","textures/gui/mpLog.png");
    	  if(DQM.conf.guiPositionTarget ==4 && DQM.conf.guiPositionMode == 1)
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpLog_Edit.png");
    	  }else
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpLog.png");
    	  }
          mc.renderEngine.bindTexture(reLoc);
          this.drawTexturedModalRect(x, y0, 0, 0, 256, 80);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[0], x + 3 , y1, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[1], x + 3, y2, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[2], x + 3, y3, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[3], x + 3, y4, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[4], x + 3, y5, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[5], x + 3, y6, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[6], x + 3, y7, 0xffffffff);
          mc.fontRenderer.drawStringWithShadow(DQM.dqmLog[7], x + 3, y8, 0xffffffff);
