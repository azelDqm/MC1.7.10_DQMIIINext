...
import dqmIII.gui.inventory.InventoryItemJobChange;
import dqmIII.gui.inventory.SlotJobChange;
...
public class GuiJobChangeContainer extends Container
{
    ...
    public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if(slot.getStack() != null && slot.getStack().getItem() == DQM.instance.InventoryItemJobChange)
            {
                return null;
            }
            */
