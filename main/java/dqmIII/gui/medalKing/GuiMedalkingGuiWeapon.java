...
import dqmIII.gui.medalKing.tab.TabManager;
...
public class GuiMedalkingGuiWeapon extends InventoryEffectRenderer
{
	...
	protected static final ResourceLocation field_147001_a = new ResourceLocation("dqm:textures/gui/gui_Medalking.png");
    ...
    public GuiMedalkingGuiWeapon(EntityPlayer p_i1094_1_)
    {
    	...
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQM.conf.GuiID_MKWeapon));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, PlayerTabs.tabMedalWeapon,false);
