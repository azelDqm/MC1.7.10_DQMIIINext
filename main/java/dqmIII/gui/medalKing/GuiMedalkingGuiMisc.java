...
public class GuiMedalkingGuiMisc extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiMisc(EntityPlayer p_i1094_1_)
    {
    	...
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQM.conf.GuiID_MKMisc));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, PlayerTabs.tabMedalMisc,false);
