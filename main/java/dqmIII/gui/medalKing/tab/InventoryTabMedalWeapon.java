...
public class InventoryTabMedalWeapon  extends AbstractTab {
	...
	public void onTabClicked() {
		//System.out.println("click" + DQM.conf.GuiID_MKWeapon);
		PacketHandler.INSTANCE.sendToServer(new MessageServerGuiId(DQM.conf.GuiID_MKWeapon));
		//mc.thePlayer.openGui(DQM.instance, DQM.conf.GuiID_MKWeapon, mc.thePlayer.worldObj, (int)mc.thePlayer.posX, (int)mc.thePlayer.posY, (int)mc.thePlayer.posZ);
