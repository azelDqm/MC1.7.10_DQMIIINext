...
public class GuiMedalkingGuiMagic2 extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiMagic2(EntityPlayer p_i1094_1_)
    {
    	...
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQM.conf.GuiID_MKMagic2));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, PlayerTabs.tabMedalMagic2,false);
