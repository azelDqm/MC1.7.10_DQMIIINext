...
public class GuiMedalkingGuiArmor extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiArmor(EntityPlayer p_i1094_1_)
    {
    	...
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQM.conf.GuiID_MKArmor));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, PlayerTabs.tabMedalArmor,false);
