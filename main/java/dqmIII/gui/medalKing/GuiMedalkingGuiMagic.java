...
public class GuiMedalkingGuiMagic extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiMagic(EntityPlayer p_i1094_1_)
    {
    	...
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQM.conf.GuiID_MKMagic));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, PlayerTabs.tabMedalMagic,false);
