...
public class InventoryMedalking implements IInventory
{
    ...
    public InventoryMedalking(InventoryPlayer inventory, EntityPlayer ep, int guiId)
    {
        ...
        if(guiId == DQM.conf.GuiID_MKWeapon)
        {
        	itemMap = DQM.medalItem.medalWeapon;
        }else if(guiId == DQM.conf.GuiID_MKArmor)
        {
        	itemMap = DQM.medalItem.medalArmor;
        }else if(guiId == DQM.conf.GuiID_MKMagic)
        {
        	itemMap = DQM.medalItem.medalMagic;
        }else if(guiId == DQM.conf.GuiID_MKMagic2)
        {
        	itemMap = DQM.medalItem.medalMagic2;
        }else if(guiId == DQM.conf.GuiID_MKJob)
        {
        	itemMap = DQM.medalItem.medalJobchange;
        }else if(guiId == DQM.conf.GuiID_MKMisc)
        {
        	itemMap = DQM.medalItem.medalItem;
        }
