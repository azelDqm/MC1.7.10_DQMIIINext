...
public class GuiMedalkingGuiJob extends InventoryEffectRenderer
{
    ...
    public GuiMedalkingGuiJob(EntityPlayer p_i1094_1_)
    {
    	...
    	super(new GuiMedalkingContainer(p_i1094_1_.inventory, DQM.conf.GuiID_MKJob));
    	this.ySize = 173;
    ...
    public void initGui()
    {
        ...
        TabManager.updateTabValues(cornerX, cornerY,this.buttonList, PlayerTabs.tabMedalJob,false);
