  ...
  public void onRenderPlayerStatus(RenderGameOverlayEvent event)
  {
	...
	*/
      ...
      if (DQM.conf.guiPositionMode == 1)
      {
          ...
          String targetGUI =  I18n.format("gui.position.guiname." + DQM.conf.guiPositionTarget);
          String line1 = I18n.format("gui.position.line.1", new Object[]{targetGUI});
          String line2 = I18n.format("gui.position.line.2", new Object[]{DQM.conf.guiPositionSpeed});
          ...
          reLoc = new ResourceLocation("dqm","textures/gui/guiEditMode.png");
          mc.renderEngine.bindTexture(reLoc);
