  ...
  public void onRenderPlayerStatus(RenderGameOverlayEvent event)
  {
	...
	*/
      ...
      if (DQM.conf.CLGuiArmorVis == 1)
      {
          ...
          x = x + DQM.conf.CLGuiArmorPosX;
          y0 =y0 + DQM.conf.CLGuiArmorPosY;
...
/*
          ...
          {
        	  sJukuren2 = I18n.format("gui.status.ability", new Object[]{JukurenEXP, DQM.exp.getJukurenNextExp(Jukuren)});
          }
*/
          y1 = y0 + 3;
          y2 = y0 + 20;
          ...
          ResourceLocation reLoc;// = new ResourceLocation("dqm","textures/gui/mpStatusArmor.png");
    	  if(DQM.conf.guiPositionTarget ==3 && DQM.conf.guiPositionMode == 1)
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpStatusArmor_Edit.png");
    	  }else
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpStatusArmor.png");
    	  }
          mc.renderEngine.bindTexture(reLoc);
