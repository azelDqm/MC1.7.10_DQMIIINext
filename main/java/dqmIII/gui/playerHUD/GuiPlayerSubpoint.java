...
public class GuiPlayerSubpoint extends Gui
{
  ...
  public void onRenderPlayerStatus(RenderGameOverlayEvent event)
  {
	...
	*/
      ...
      if (DQM.conf.CLGuiSubpointsVis == 1)
      {
          y0 = 0;
          y1 = 0;
          y2 = 0;
          ...
          switch (DQM.conf.CLGuiSubpointsPos)
          {
              case 1:
                  x = padW;
                  y0 = 2;
          ...
          x = x + DQM.conf.CLGuiSubpointsPosX;
          y0 =y0 + DQM.conf.CLGuiSubpointsPosY;
    	  ...
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpStatus4_Edit.png");
    	  }else
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpStatus4.png");
    	  }
