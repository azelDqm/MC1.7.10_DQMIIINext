  ...
  public void onRenderPlayerStatus(RenderGameOverlayEvent event)
  {
	...
	*/
      ...
      if (DQM.conf.CLGuiVis2 == 1)
      {
          ...
          x = x + DQM.conf.CLGuiPos2X;
          y0 =y0 + DQM.conf.CLGuiPos2Y;
    	  ...
    	  if(DQM.conf.guiPositionTarget ==2 && DQM.conf.guiPositionMode == 1)
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpStatus3_Edit.png");
    	  }else
    	  {
    		  reLoc = new ResourceLocation("dqm","textures/gui/mpStatus3.png");
    	  }
